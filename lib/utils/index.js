...
export const graphValue = (fieldData, allData) => {
    switch(fieldData.type){
        ...
        case "chapter":
            return {
                ...fieldData,
                writer: !fieldData.writer ? [] : fieldData.writer.map((item) => {
                    return allData[item]
                }),
                book: !fieldData.book ? [] : fieldData.book.map((item) => {
                    return allData[item]
                })
            }
        case "easton":
            return {
                ...fieldData,
                personLookup: !fieldData.personLookup ? [] : fieldData.personLookup.map((item) => {
                    return allData[item]
                })
            }
        case "event":
            return {
                ...fieldData,
                participants: !fieldData.participants ? [] : fieldData.participants.map((item) => {
                    return allData[item]
                }),
                verses: !fieldData.verses ? [] : fieldData.verses.map((item) => {
                    return allData[item]
                }),
                locations: !fieldData.locations ? [] : fieldData.locations.map((item) => {
                    return allData[item]
                })
            }
        case "people":
            return {
                ...fieldData,
                father: !fieldData.father ? [] : fieldData.father.map((item) => {
                    return allData[item]
                }),
                mother: !fieldData.mother ? [] : fieldData.mother.map((item) => {
                    return allData[item]
                }),
                siblings: !fieldData.siblings ? [] : fieldData.siblings.map((item) => {
                    return allData[item]
                }),
                children: !fieldData.children ? [] : fieldData.children.map((item) => {
                    return allData[item]
                })
            }
        case "peopleGroup":
        ...
        case "period":
            return {
                ...fieldData,
                peopleBorn: !fieldData.peopleBorn ? [] : fieldData.peopleBorn.map((item) => {
                    return allData[item]
                }),
                peopleDied: !fieldData.peopleDied ? [] : fieldData.peopleDied.map((item) => {
                    return allData[item]
                }),
                booksWritten: !fieldData.booksWritten ? [] : fieldData.booksWritten.map((item) => {
                    return allData[item]
                })
            }
        case "place":
            ...
            return {
                ...fieldData,
                eventsHere: !fieldData.eventsHere ? [] : fieldData.eventsHere.map((item) => {
                    return allData[item]
                }),
                booksWritten: !fieldData.booksWritten ? [] : fieldData.booksWritten.map((item) => {
                    return allData[item]
        ...
        case "verse":
            return {
                ...
                chapter: !fieldData.chapter ? [] : fieldData.chapter.map((item) => {
                    return allData[item]
                }),
                people: !fieldData.people ? [] : fieldData.people.map((item) => {
                    return allData[item]
                })
            }
    }
